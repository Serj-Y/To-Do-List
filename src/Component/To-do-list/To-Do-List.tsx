      ...
      <ThemeProvider theme={OwnTheme}>
        <FormControl>
          <h2>
            ...
            <Button size="small" variant="outlined" onClick={removeTodolist}>
              <ClearOutlinedIcon />
            </Button>{" "}
          </h2>
          ...
          <RadioGroup defaultValue="all" name="radio-buttons-group" row>
            <FormControlLabel
              value="all"
              control={<Radio onChange={onAllClickHandler} />}
              label="All"
            />
            <FormControlLabel
              value="active"
              control={<Radio onChange={onActiveClickHandler} />}
              label="Active"
            />
            <FormControlLabel
              value="completed"
              control={<Radio onChange={onCompletedClickHandler} />}
              label="Completed"
            />
          </RadioGroup>
        </FormControl>
